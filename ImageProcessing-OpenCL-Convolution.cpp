// g++ -o exe ImageProcessing-OpenCL-Convolution.cpp -lOpenCL -I/usr/include -L/usr/lib
...
// Naive kernel
const char* naiveKernelSource = R"(
...
// Optimized kernel
const char* optimizedKernelSource = R"(
    ...
    __local float* tile)
{
    ...
    // Initialize tile and load center pixel
...
int main() {
    ...
    programNaive = clCreateProgramWithSource(context, 1, &naiveKernelSource, nullptr, &err);
    programOptimized = clCreateProgramWithSource(context, 1, &optimizedKernelSource, nullptr, &err);
    if (err != CL_SUCCESS) {
